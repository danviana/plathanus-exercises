...
#                                     root GET    /                                                                                                 menu#index
#                           roman_numerals GET    /roman_numerals(.:format)                                                                         roman_numerals#index
...
#                                 property PATCH  /properties/:id(.:format)                                                                         properties#update
#                                          PUT    /properties/:id(.:format)                                                                         properties#update
#                                          DELETE /properties/:id(.:format)                                                                         properties#destroy
#                                          GET    /properties/:property_id/images/:attachment_id(.:format)                                          properties#remove_image
...
Rails.application.routes.draw do
  ...
  resources :roman_numerals, only: %i[index]

  resources :properties, except: %i[show]
  get 'properties/:property_id/images/:attachment_id', to: 'properties#remove_image'
end
